...
- 5e81428: Add the operator REST API (`/api/v1`) behind `SCRUBJAY_API_TOKEN`: guild/channel
...
- efbe252: Dispatch alert plans concurrently across channels. Sends to different channels
...
- 8d8f264: Name the pg pool in connection metrics and stop double-emitting them.
